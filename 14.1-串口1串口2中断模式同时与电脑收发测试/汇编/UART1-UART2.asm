...
TestString1:                    ;Test string
    DB  "AI8051U Uart1 Test Programme!",0DH,0AH,0
TestString2:                    ;Test string
    DB  "AI8051U Uart2 Test Programme!",0DH,0AH,0
...
;   ANL     P_SW2, #NOT 0x01    ; UART2 switch to P1.2 P1.3
    ORL     P_SW2, #0x01        ; UART2 switch to P4.2 P4.3
    CLR     B_TX2_Busy
    MOV     RX2_Cnt, #0;
    MOV     TX2_Cnt, #0;
L_Uart2NotUseTimer2:
