...
void DrawTestPage(u8 *str)
{
	...
	Gui_StrCenter(0,lcddev.height-18,WHITE,BLUE,"www.STCAIMCU.com",16,1);//居中显示
	//绘制测试区域
...
void main_test(void)
{
	DrawTestPage("3.5寸TFT屏测试程序");
	
	Gui_StrCenter(0,60,RED,BLUE,"深圳国芯人工智能有限公司",16,1);//居中显示
	Gui_StrCenter(0,90,RED,BLUE,"STC AI Limited",16,1);//居中显示	
...
{	
	...
	Show_Str(10,30,BLUE,YELLOW,"16X16:深圳国芯人工智能有限公司欢迎您",16,0);
	Show_Str(10,50,BLUE,YELLOW,"16X16:Welcome深圳国芯",16,0);
	Show_Str(10,70,BLUE,YELLOW,"24X24:深圳国芯中文测试",24,1);
