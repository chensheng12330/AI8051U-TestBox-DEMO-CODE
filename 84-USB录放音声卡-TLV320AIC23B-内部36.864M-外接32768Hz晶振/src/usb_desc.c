...
char code CONFIGDESC[194] =
{
    ...
    0x02,                   //bInCollection(2 AudioStreaming interface)
    0x01,                   //baInterfaceNr(AS #1, Interface 1 is stream)
    0x02,                   //baInterfaceNr(AS #2, Interface 2 is stream)

    0x0c,                   //bLength(12)
    0x24,                   //bDescriptorType(CS_INTERFACE)
    0x02,                   //bDescriptorSubtype(INPUT_TERMINAL)
    0x01,                   //bTerminalID(1)
    0x01,0x02,              //wTerminalType(USB Microphone)
    ...
    0x02,                   //bUnitID(2)
    0x01,                   //bSourceID(#1, Microphone IT)
    0x01,                   //bControlSize(1)
    ...
    0x06,                   //bDescriptorSubtype(FEATURE_UNIT)
    0x05,                   //bUnitID(5)
    0x04,                   //bSourceID(#4, USB Streaming IT)
    0x01,                   //bControlSize(1)
    0x01,                   //bmaMasterControls(Mute)
    0x00,                   //bmaChannelControls(Volume)
    0x00,                   //bmaChannelControls(Volume)
    ...
    0x03,                   //bTerminalLink(USB Streaming OT)
    0x01,                   //bDelay(1)
    ...
    R_BLOCKSIZE,0x00,       //wMaxPacketSize(128)
    ...
    0x24,                   //bDescriptorType(CS_INTERFACE)
    0x01,                   //bDescriptorSubtype(AS_GENERAL)
    0x04,                   //bTerminalLink(USB Streaming IT)
    0x01,                   //bDelay(1)
    0x01,0x00,              //wFormatTag(PCM format)
    ...
    0x05,                   //bmAttributes(Asynchronous)
    S_BLOCKSIZE,0x00,       //wMaxPacketSize(192)
    0x01,                   //bInterval(1 millisecond)
    0x00,                   //bRefresh(0)
    0x00,                   //bSynchAddress(no synchronization)
